...
static CatVar heal_steamid_perm(CV_SWITCH, "autoheal_steamid_only", 0, "Only heal target with steamid, set steamid to 0 to reset. (this does NOT set the target, it only sets it to never not heal the target.)");
