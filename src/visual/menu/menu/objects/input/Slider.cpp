...
settings::RVariable<glez::rgba> SliderStyle::handle_body{ "zk.style.input.slider.color.handle_body", "1d2f40" };
settings::RVariable<glez::rgba> SliderStyle::handle_border{ "zk.style.input.slider.color.handle_border", "079797" };
settings::RVariable<glez::rgba> SliderStyle::bar_color{ "zk.style.input.slider.color.bar", "079797" };
