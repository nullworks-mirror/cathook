...
void zerokernel::special::PlayerListController::setOpenSteamCallback(
        zerokernel::special::PlayerListController::open_steam_callback_type callback)
{
...
void zerokernel::special::PlayerListController::updatePlayerName(int id,
                                                                 const char *name)
{
...
void zerokernel::special::PlayerListController::addPlayer(int id,
...
void
zerokernel::special::PlayerListController::changeRowColor(zerokernel::TRow *row, const glez::rgba& color)
{
