...
public:
    ...
    {
        m_KeyValues->SetBool("hover", true);
    }
    inline virtual void OnMouseLeave()
    {
        m_KeyValues->SetBool("hover", false);
    }
    inline virtual void OnMousePress()
    {
        m_KeyValues->SetBool("press", true);
    }
    inline virtual void OnMouseRelease()
    {
        m_KeyValues->SetBool("press", false);
    }
    ...
    {
        m_KeyValues->SetBool("focus", true);
    }
    inline virtual void OnFocusLose()
    {
        m_KeyValues->SetBool("focus", false);
    }

    inline virtual void HandleCustomEvent(KeyValues *event){};

    inline virtual bool ConsumesKey(ButtonCode_t key)
    {
        return false;
    }

    inline virtual bool AlwaysVisible()
    {
        return m_KeyValues->GetBool("always_visible");
    }

    inline virtual void Show()
    {
        m_KeyValues->SetBool("visible", true);
    }
    inline virtual void Hide()
    {
        m_KeyValues->SetBool("visible", false);
    }
    ...
    {
        return std::make_pair(m_KeyValues->GetInt("offset_x"),
                              m_KeyValues->GetInt("offset_y"));
    }
    inline virtual std::pair<int, int> GetSize()
    {
        return std::make_pair(m_KeyValues->GetInt("size_x"),
                              m_KeyValues->GetInt("size_y"));
    }
    inline virtual std::pair<int, int> GetMaxSize()
    {
        return std::make_pair(m_KeyValues->GetInt("max_x"),
                              m_KeyValues->GetInt("max_y"));
    }
    inline virtual int GetZIndex()
    {
        return m_KeyValues->GetInt("zindex");
    }
    inline virtual void SetZIndex(int idx)
    {
        m_KeyValues->SetInt("zindex", idx);
    }

    inline virtual std::string GetTooltip()
    {
        return std::string(m_KeyValues->GetString("tooltip"));
    }

    inline virtual PositionMode GetPositionMode()
    {
        return (PositionMode) m_KeyValues->GetInt("positionmode");
    }
    inline virtual void SetPositionMode(PositionMode mode)
    {
        m_KeyValues->SetInt("positionmode", mode);
    };
    ...
    inline virtual void SetParent(IWidget *parent)
    {
        m_pParent = parent;
    }
    inline virtual std::string GetName()
    {
        return std::string(m_KeyValues->GetString("name"));
    }
